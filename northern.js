document.addEventListener("DOMContentLoaded", function() {
    ...
    const northernLog = document.getElementById("northernLog");

    // Email validation
    function validateEmail(email) {
        return email.endsWith("@cncc.edu");
    }
    ...
    northernLog.addEventListener("submit", function(event) {
        ...
        .then(data => {
            ...
            setTimeout(() => {
                window.location.href = "CNCC.html";
            }, 2000);
        })
        .catch(error => {
